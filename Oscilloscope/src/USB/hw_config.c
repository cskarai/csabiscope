...
/*******************************************************************************
* Function Name  : USB_Interrupts_SetLowPriority
* Description    : Configures USB interrupts to low priority
* Input          : None.
* Return         : None.
*******************************************************************************/
void USB_Interrupts_SetLowPriority(void)
{
	NVIC_InitTypeDef NVIC_InitStructure;
...
/*******************************************************************************
* Function Name  : USB_Interrupts_SetHighPriority
* Description    : Configures USB interrupts to high priority
* Input          : None.
* Return         : None.
*******************************************************************************/
void USB_Interrupts_SetHighPriority(void)
{
	NVIC_InitTypeDef NVIC_InitStructure;
